...
public class SwipeButton extends RelativeLayout {
    ...
    private OnSwipeActiveListener onSwipeActiveListener;
    ...
    public void setOnActiveListener(OnSwipeActiveListener onSwipeActiveListener) {
        this.onSwipeActiveListener = onSwipeActiveListener;
    }
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        if (attrs != null && defStyleAttr == -1 && defStyleRes == -1) {
            ...
            if (backgroundDrawable != null) {
                ...
                background.setBackground(ContextCompat.getDrawable(context, R.drawable.bg_swipe_shape_rounded));
            }
            ...
            if (buttonBackground != null) {
                ...
                swipeButtonInner.setBackground(ContextCompat.getDrawable(context, R.drawable.bg_swipe_shape_button));
            }
            ...
            switch (event.getAction()) {
                ...
                case MotionEvent.ACTION_MOVE:
                    ...
                    if (event.getX() > swipeButtonInner.getWidth() / 2 &&
                        ...
                        centerText.setAlpha(1 - 1.3f * (swipeButtonInner.getX() +
                    ...
                    if (active) {
                        ...
                        if (swipeButtonInner.getX() + swipeButtonInner.getWidth() > getWidth() * 0.9) {
                            if (hasActivationState) {
                                expandButton();
                            } else if (onSwipeActiveListener != null) {
                                onSwipeActiveListener.onActive();
                                moveButtonBack();
                            }
                        } else {
                            moveButtonBack();
    ...
    public void setCenterTextColor(Context context, int color) {
        centerText.setTextColor(ContextCompat.getColor(context, color));
    }

    public void setCenterTextStyle(int style) {
        centerText.setTextAppearance(style);
    }
