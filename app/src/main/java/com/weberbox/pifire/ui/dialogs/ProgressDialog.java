...
public final class ProgressDialog extends AbstractDialog {

    @SuppressWarnings("rawtypes")
    private ProgressDialog(@NonNull final Activity activity,
        ...
        View dialogView = createProgressDialogView(inflater, null);
    ...
    public static class Builder extends AbstractDialog.Builder<ProgressDialog> {
