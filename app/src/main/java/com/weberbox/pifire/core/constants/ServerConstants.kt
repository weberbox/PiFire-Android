...
object ServerConstants {
    ...
    const val PT_RESTART_CONTROL: String = "restart_control"
    const val PT_RESTART_WEBAPP: String = "restart_webapp"
    const val PT_RESTART_SUPERVISOR: String = "restart_supervisor"
